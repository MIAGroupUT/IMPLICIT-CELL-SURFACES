...
output_dir = './renders_cele_demo_01';
...
for i = 1:size(sdf_vid,1)
    ...
    centered_vol = imresize3(uint8(vol * 255), [256 256 256], 'linear');
    centered_vol = imgaussfilt3(centered_vol, 7);
    ...
    % save image
    filename = strcat('cell_cele_t', sprintf('%03d', i-1));
